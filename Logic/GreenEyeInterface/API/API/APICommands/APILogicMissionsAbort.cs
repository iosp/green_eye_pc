...
{
    public class APILogicMissionsAbort : IAPICommand
    {
        private string[] mPaths = { "/api/logic/missions/{missionId}/abort" };
        ...
        protected override string ExecutePostCommand(string pURLPath, API.EnumAPIFormat pFormat, System.Collections.Specialized.NameValueCollection pParameters)
        {
            ...
            try
            {
                LogicServerBLInterface.Instance().AbortMission(MissionID);
